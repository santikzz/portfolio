        ...
        <>
            <aside className={`fixed left-0 top-0 h-[100vh] bg-neutral-900 bg-opacity-75 backdrop-blur-lg w-[80vw] z-50 transition-transform 200ms ease-linear ${!isOpen && '-translate-x-full'}`}>
                ...
                <div className="flex flex-col gap-8 p-8">
                    ...
                    <a href="https://github.com/santikzz" className="flex flex-row text-white items-center gap-2 font-geist-mono text-lg">
                    ...
                    <a href="https://www.linkedin.com/in/santiago-bugn%C3%B3n-a71a54217/" target="_blank" className="flex flex-row text-white items-center gap-2 font-geist-mono text-lg">
                    ...
                    <a href="mailto:santiago_bugnon@hotmail.com" target="_blank" className="flex flex-row text-white items-center gap-2 font-geist-mono text-lg">
